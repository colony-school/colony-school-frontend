  ...
  return (
    <div
      className="flex flex-row justify-between items-center w-full h-12 container-surface
        overflow-hidden shadow focus-visible: rounded-full"
    >
      <button
      ...
      <input
        className="block w-full h-full container-surface focus-visible:
      ...
      <button
        className="btn-text grid place-items-center h-full px-4
          text-light-on-surface dark:text-dark-on-surface focus-visible:"
      >
